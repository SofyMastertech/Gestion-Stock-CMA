...
class GestionReactifs(QWidget):
    ...
    def add_sixth_row_widgets(self, groupbox):
        ...
        self.comboBox_analyse_sixRow.addItems(self.populate_analytes_combo)
        ...
        completer = QCompleter(self.populate_analytes_combo, self.comboBox_analyse_sixRow)
        ...
        self.comboBox_unite_qt_a_commander_sixRow.addItems(self.populate_analytes_combo)
